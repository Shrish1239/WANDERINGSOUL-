...
from Japanese.data import LOVERAID
...
async def loveraid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            await e.reply(f"𝙼𝙾𝙳𝚄𝙻𝙴 𝙽𝙰𝙼𝙴 : 𝙻𝙾𝚅𝙴𝚁𝙰𝙸𝙳\n  » {hl}𝙻𝙾𝚅𝙴𝚁𝙰𝙸𝙳 <𝙲𝙾𝚄𝙽𝚃> <𝚄𝚜𝚎𝚛𝚗𝚊𝚖𝚎 𝙾𝚏 𝚄𝚜𝚎𝚛 𝚋𝚊𝚋𝚢❤️💋>\n  » {hl}𝙻𝙾𝚅𝙴𝚁𝙰𝙸𝙳 <𝙲𝙾𝚄𝙽𝚃> <𝚁𝚎𝚙𝚕𝚢 𝚃𝚘 𝙰 𝚄𝚜𝚎𝚛 𝚋𝚊𝚋𝚢❤️💋>")
